...
public class LoginXmpp implements  MultiInstance{
	...
	public PrivacyListsManager privacyListsManager;
	public SessionReconnect reconnectModule;
	...
	LoginXmpp(XmppConnection xmppConnection, XmppSession xmppSession, SASLManager saslManager,  ResourceBindingManager bindingManager, 
			...
			XmppRoster xmppRoster, RoomManager roomManager, DiscoveryManager discoveryManager, RoomDiscoveryManager roomDiscoveryManager,
